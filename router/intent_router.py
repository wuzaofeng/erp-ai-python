...
_COMPLEX_KEYWORDS = [
    # 主动查询动词
    "查询", "查找", "查一下", "查下", "搜索", "搜一下", "列出", "显示", "展示",
    "统计", "汇总", "分析", "看一下", "看下", "给我看", "帮我查", "帮我找",
    # 多轮追问 / 条件变更
    "再查", "重新查", "再帮我", "再过滤", "再筛选", "换条件", "换成",
    "只看", "只要", "过滤", "筛选", "过滤出", "筛出",
    "下一页", "上一页", "翻页", "更多", "查更多", "再来", "继续查",
    "按照", "排序", "排一下", "升序", "降序",
    # ERP 业务实体
    "订单", "采购", "销售", "库存", "客户", "供应商", "财务", "发票",
    "报表", "数据", "记录", "明细", "员工", "物料", "仓库", "应付", "应收",
    "合同", "报价", "出库", "入库", "盘点", "结算", "凭证", "账单",
]
